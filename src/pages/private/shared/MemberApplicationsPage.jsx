...
const MemberApplicationsPage = ({
  ...
  const showInterviewStatusColumn = role === "admin";
      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-800 bg-gray-900/90 shadow-xl">
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-center">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Link
                            to={`${basePath}/final-review/${application.id}`}
          ...
          {filteredApplications.length === 0 && (
            <div className="border-t border-gray-800 px-3 py-10 text-center text-sm text-gray-400">
