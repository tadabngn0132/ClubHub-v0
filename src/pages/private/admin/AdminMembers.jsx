...
const AdminMembers = () => {
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="overflow-auto max-h-[calc(100vh-180px)] relative border border-gray-200">
        <table className="w-full border-collapse table-auto">
          <thead className="sticky top-[-1px] text-white z-10 w-full bg-[var(--black-color)]">
