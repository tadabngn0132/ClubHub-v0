    ...
    <div className="min-h-screen text-slate-100">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-slate-700/60 bg-slate-900/65 p-5 md:p-6">
            <h2 className="mb-4 text-lg font-bold">Admin Actions</h2>
          ...
          <div className="rounded-2xl border border-slate-700/60 bg-slate-900/65 p-5 md:p-6">
            <h2 className="mb-4 text-lg font-bold">Admin Tools</h2>
            <div className="grid gap-3 sm:grid-cols-2">
              <button
                className="rounded-xl bg-teal-500 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-teal-400 cursor-pointer"
