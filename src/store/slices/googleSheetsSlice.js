  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(exportMemberListToSheetAsync.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.payload || "Failed to export member list to sheet.";
      })
      ...
      .addCase(exportAttendanceReportToSheetAsync.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.payload || "Failed to export attendance report to sheet.";
      })
      ...
      .addCase(fetchGoogleSheetEmbedLinkAsync.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.payload || "Failed to fetch Google Sheet embed link.";
      });
  },
});
