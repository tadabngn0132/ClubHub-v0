...
const Header = () => {
  return (
    <div className="flex justify-between items-center p-2 pl-9 pr-9 fixed w-full backdrop-blur-md z-50">
      <nav className="flex items-center justify-between w-[87.5%] md:w-max md:gap-10 md:justify-baseline">
        ...
        <div className="flex items-center">
          ...
          <ul className="hidden md:flex">
            <li className="monument-regular p-9 pt-3.5 pb-3.5 font-bold text-[1rem] hover:text-[#DB3F7A] cursor-pointer">
