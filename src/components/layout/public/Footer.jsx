      ...
      <div className="flex flex-col items-start mt-3 xl:mt-1 lg:flex-row lg:justify-between lg:items-end">
        ...
        <div className="flex flex-col justify-baseline mt-15 lg:mt-0 xl:mt-0 gap-6 xl:gap-4 xl:h-full lg:items-end">
          <div className="flex flex-col text-xl xl:text-lg items-start gap-1 ">
            <h3 className="text-[var(--pink-color)] font-medium lg:self-end">
              CONTACT
            </h3>
          ...
          <div className="flex flex-col items-start gap-1">
            <h3 className="text-[var(--pink-color)] text-xl xl:text-lg font-medium mb-1.5 lg:self-end">
              FOLLOW US
            </h3>
            <div className="">
              <a
                href="https://www.facebook.com/gdcgwdance"
                target="_blank"
                className="hover:text-[var(--pink-color)] text-2xl mr-4.5 lg:mr-0 lg:ml-4.5"
              >
                <FontAwesomeIcon icon={faFacebookF} size="lg" />
              </a>
              <a
                href="https://www.instagram.com/gdc.gwhn/"
                target="_blank"
                className="hover:text-[var(--pink-color)] text-2xl mr-4.5 lg:mr-0 lg:ml-4.5"
              >
              ...
              <a
                href="https://www.tiktok.com/@greenwichdancecrew"
                target="_blank"
                className="hover:text-[var(--pink-color)] text-2xl mr-4.5 lg:mr-0 lg:ml-4.5"
              >
              ...
              <a
                href="https://www.youtube.com/@GDC-GreenwichDanceCrew"
                target="_blank"
                className="hover:text-[var(--pink-color)] text-2xl mr-4.5 lg:mr-0 lg:ml-4.5"
              >
