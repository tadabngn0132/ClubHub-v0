...
const Footer = () => {
  return (
    <div className="flex flex-col p-2 pl-9 pr-9 gap-6">
      <img className="w-60 md:w-55" src="src/assets/logos/GDC_logo.svg" alt="GDC Logo" />
      <div className="flex flex-col items-start md:flex-row md:justify-between md:items-start">
        <div>
          <h1 className="monument-regular text-[1.6rem] md:text-3xl">
        ...
        <div className="flex flex-col justify-baseline mt-10 md:mt-0 gap-6">
      ...
      <div className="flex flex-col mt-1 md:mt-8 gap-6">
